 ...
 */
class CustomXboxController : public GenericHID {
 public:
  /**
   ...
   *             into (0-5).
   */
  explicit CustomXboxController(int port);

  ~CustomXboxController() override = default;

  CustomXboxController(CustomXboxController&&) = default;
  CustomXboxController& operator=(CustomXboxController&&) = default;
